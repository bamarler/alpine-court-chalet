  ...
  amenities: [
    {
      ...
      items: [
        ...
        {
          name: "Championship Pickleball Court (coming soon)",
          schemaName: "pickleballCourt",
        },
        { name: "Integrated Audio System", schemaName: "soundSystem" },
        { name: "Billiards Room with Pool Table", schemaName: "poolTable" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Commercial-Grade Dishwasher", schemaName: "dishwasher" },
        { name: "Built-In Microwave", schemaName: "microwave" },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Premium Egyptian Cotton Linens", schemaName: "bedLinens" },
        { name: "Professional Hair Dryer", schemaName: "hairDryer" },
        { name: "Executive Home Office", schemaName: "workspace" },
        { name: "Private Gated Entrance", schemaName: "privateEntrance" },
      ],
    },
    {
      category: "Family Amenities",
      items: [
        { name: "Designer Crib", schemaName: "crib" },
        { name: "Deluxe Pack 'n Play Travel Crib", schemaName: "travelCrib" },
        { name: "Premium High Chair", schemaName: "highChair" },
        {
