...
export default function ContactSectionAnimated({
  ...
  return (
    <section id="contact" className="scroll-mt-8 bg-neutral-50 py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
            ...
            <p className="mt-1 text-sm text-neutral-500">Property Manager</p>
        ...
        >
          <a
            href="/house-rules"
            className="inline-flex items-center gap-2 rounded-lg border border-neutral-300 bg-white px-6 py-3 font-medium text-neutral-700 transition-colors hover:border-primary-300 hover:bg-primary-50 hover:text-primary-700"
          >
